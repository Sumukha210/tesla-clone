...
import img from "@/assets/images/modelx-page/MX-Performance-Hero-Desktop.jpg";
...
const PlaidModel = () => {
  const data: featureType = {
    ...
    description:
      "Model X Plaid has the quickest acceleration of any vehicle in production. Updated battery architecture for all Model S trims enables back-to-back track runs without performance degradation",
  };
  ...
  return (
    <>
      <SectionLayout1 {...data} btn1Path="/modelx/design">
        <OverlapOnMedia>
          <Content>
